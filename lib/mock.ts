...
export const syrianCities: SyrianCity[] = [
  ...
  },
  {
    ...
    name: "Palmyra",
    name_ar: "تدمر",
    description: "The bride of the desert, home to the magnificent Zenobia.",
    description_ar: "عروس الصحراء وموطن الملكة زنوبيا العظيمة.",
    unlocked: false,
    landmark: "مسرح تدمر",
  },
  {
    ...
    name: "Bosra",
    name_ar: "بصرى الشام",
    description: "Known for its perfectly preserved Roman theater.",
    description_ar: "مشهورة بمسرحها الروماني الفريد والمحفوظ بالكامل.",
    unlocked: false,
    landmark: "قلعة بصرى",
  },
  {
...
export const latakiaStories: Story[] = [
  {
    ...
    content_ar: "في مملكة أوغاريت، على ساحل البحر المتوسط، اجتمع الحكماء لابتكار حروف سهلة بدلاً من الصور المعقدة. هكذا ولدت أول أبجدية في التاريخ، لتعلم العالم كله كيف يكتب ويقرأ.",
  },
  {
    id: "zenobia-queen",
    title: "Queen Zenobia",
    title_ar: "الملكة زنوبيا العظيمة",
    category: "history",
    location: "تدمر",
    imageUrl: "https://images.unsplash.com/photo-1590001158193-7904d1ef417a?w=800&auto=format&fit=crop",
    content: "Zenobia was a powerful queen of the Palmyrene Empire...",
    content_ar: "في قلب البادية السورية، حكمت الملكة زنوبيا مدينة تدمر الذهبية. كانت قوية وذكية، حولت تدمر إلى مركز للعلم والفن، وما زالت أعمدتها العالية تحكي قصة شجاعتها حتى اليوم.",
  },
  {
    id: "aleppo-citadel",
    title: "The Citadel of Aleppo",
    title_ar: "قلعة حلب الصامدة",
    category: "history",
    location: "حلب",
    imageUrl: "https://images.unsplash.com/photo-1590001158193-7904d1ef417a?w=800&auto=format&fit=crop",
    content: "Standing tall above the city, the Citadel of Aleppo...",
    content_ar: "فوق تلة عالية في مدينة حلب، تقف القلعة العظيمة كحارس أمين. هي واحدة من أقدم وأكبر القلاع في العالم، خنادقها العميقة وأبوابها الضخمة تخفي أسراراً من آلاف السنين.",
  },
];
